...
For part 4 of the assignment which requires analysis of the PageRank results:
============================================================================
	a. Created a file called PageRank Analysis.txt which contains the analysis of the page rank results obtained.
...
2. PageRank project folder consist of:
   ...
   i. PageRank Analysis.txt: contains the analysis of the page rank results obtained.
